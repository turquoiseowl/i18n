...
{
    /// <summary>
    /// Defines a service for retrieving localized text from data source using the
    ...
    public interface ILocalizingServiceEnhanced
    {
        ...
        string GetBestAvailableLanguageFrom(LanguageItem[] languages);
        ...
        /// <param name="languages">A sorted list of language preferences</param>
        /// <returns></returns>
        string GetText(string key, LanguageItem[] languages);
    }
}
